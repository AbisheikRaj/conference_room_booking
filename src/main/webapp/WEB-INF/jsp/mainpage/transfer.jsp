        ...
        <div>
            ...
            %>
                <div class="alert alert-success" id = "success-alert" role="alert">
                    <b>Booking Details are waiting for PMO approval.</b>
                </div>
            <%
        ...
        <c:forEach items="${bookings}" var="id">
            <tr>
                ...
                <td class="table-dark" style="text-align: center">
                    <a href="/conference_room_booking/approve/${id.getBookingId()}" role="button" class="btn btn-primary"><strong>TRANSFER</strong></a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
