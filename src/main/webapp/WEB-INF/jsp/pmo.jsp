...
<%
    ...
    if (session.getAttribute("accept_pmo") == null) {
        ...
        <div>
            ...
            %>
                <div class="alert alert-success" id = "success-alert" role="alert">
                    <b>Booking Details are successfully approved.</b>
                </div>
            <%
...
<%--                    <a href="/conference_room_booking/delete/${id.getBookingId()}" role="button" class="btn btn-success">DELETE</a>--%>
                    <a href="/conference_room_booking/approve/${id.getBookingId()}" role="button" class="btn btn-primary">APPROVE</a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
